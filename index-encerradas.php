...
<body>
    ...
    <div class="container">
    	...
    	<h1 style="margin-top:40px;">Inscrições <?php echo $inscricao_exercicio; ?></h1>

		<?php if ($inscricao_status): ?>

    	<h4>Preencha com atenção todos os itens e em seguida imprima a confirmação de matrícula.</h4>
    	<p>Em caso de dúvidas no preenchimento, entre em contato através do Fale Conosco do site, 
    	 ou fale diretamente com um dos monitores na Praça do Conhecimento.</p>    	 
    	 ...
    	 <form id="formularioInscricao" name="formularioInscricao" method="POST" action="envia.php">
    	 	<div id="escolhaCurso">
	    	 	...
	    	 	<div id="turno1" style="display:none;">
		    	 	<label>Turno:</label>
		    	 	<select id="curso_1opcao_turno" name="curso_1opcao_turno" required>
		    	 	</select>
	    	 	</div>
	    	 	...
	    	 	<div id="turno2" style="display:none;">
		    	 	<label>Turno:</label>
		    	 	<select id="curso_2opcao_turno" name="curso_2opcao_turno"  required>
		    	 	</select>
	    	 	</div>    	 	
			...
			<hr>
    	 	...
    	 	<div id="dadosPessoais">
    	 		...
    	 		<input id='estado_civil' name="estado_civil" class="input-large" type="text" placeholder="Estado civil"><span class="help-inline">Ex. solteiro, casado, divorciado, viúvo...</span><br>
			...
			<div id="escolaridade">
				...
				<div id="escolaridade_sobre" style="display:none;">
					<input id="instituicao_nome" name="instituicao_nome" class="input-xxlarge" type="text" placeholder="Escola ou Faculdade onde estuda"><br>
			...
			<div id="conhecimentos">
				...
				<select id="comunicacao" name="comunicacao" required>
					<option value=""></option>
				...
				<div id="comunicacao_outro" style="display:none;">
					<input id="comunicacao_outro_opt" name="comunicacao_outro_opt" class="input-xxlarge" type="text" placeholder="Digite o nome de onde soube da Praça do Conhecimento"><br>
				</div>
				</p>

				<p>
				<label>Qual o principal motivo de você estar se inscrevendo em um dos cursos da Praça do Conhecimento?</label>
				<select id="motivo" name="motivo" multiple="multiple" required>
					...
					<option value="5">Meus pais ou outras pessoas pediram para eu me inscrever</option>
				</select>
				...
				<div id="internet_nao" style="display:none;">
					...
					<textarea id="internet_nao_motivo" name="internet_nao_motivo" class="input-xxlarge"></textarea>
				</div>
				</p>
			</div><!-- /conhecimentos -->
			...
			<div class="social">
				...
				<select id="atividade_social" name="atividade_social" required>
					<option value=""></option>
				...
				<div id="atividade_social_nome" style="display:none;">
					<input id="atividade_social_opt_nome" name="atividade_social_opt_nome" class="input-xxlarge" type="text" placeholder="Qual?"><br>
				</div>	
