...
/*
SELECT inscricao2014_1.id, c1.curso AS  'curso1', t1.turno AS  'turno1', c2.curso AS  'curso2', t2.turno AS  'turno2', inscricao2014_1.nome, email, tel_fixo, tel_cel, tel_recado
FROM  `inscricao2014_1`
LEFT JOIN cursos c1 ON c1.sigla = inscricao2014_1.curso1
LEFT JOIN cursos c2 ON c2.sigla = inscricao2014_1.curso2
LEFT JOIN turnos t1 ON t1.id = inscricao2014_1.curso1_turno
LEFT JOIN turnos t2 ON t2.id = inscricao2014_1.curso2_turno
	...
	<div class="well">
		...
		<?php 
			...
			for ( $i=0; $i < $qdeTurnos; $i++ ) : 
				...
				$queryTurnoCurso = "SELECT inscricao2014_1.id, c1.curso AS  'curso1', t1.turno AS  'turno1', c2.curso AS  'curso2', t2.turno AS  'turno2', inscricao2014_1.nome, email, tel_fixo, tel_cel, tel_recado FROM  `inscricao2014_1` LEFT JOIN cursos c1 ON c1.sigla = inscricao2014_1.curso1 LEFT JOIN cursos c2 ON c2.sigla = inscricao2014_1.curso2 LEFT JOIN turnos t1 ON t1.id = inscricao2014_1.curso1_turno LEFT JOIN turnos t2 ON t2.id = inscricao2014_1.curso2_turno WHERE curso1 = '$cursoSigla' AND t1.id = $turnoID ORDER BY inscricao2014_1.nome ASC";
